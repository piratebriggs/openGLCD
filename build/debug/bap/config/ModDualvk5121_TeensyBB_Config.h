/*
 * ModDualvk5121_TeensyBB_Config.h - User specific configuration for Arduino GLCD library
 *
 * This configuration is for dual vk5121 displays that are treated as a single 4 chip display.
 *
 ...
 *	
 *
 * There are two of these displays, sitting next to each other side by side.
 * all connections are common to both other than the E signals.
 *
 *    <-------------------------------- 120 Pixels -------------------------------->
 *    +--------------------------------------+-------------------------------------+ 
 *    |                                      |                                     | ^
 ...
 *    +-------------------------------------------+                  |           |
 *    |11 | RW   | H = Read, L = Write            | AVR Pin ---------+ B4     D3 +-------> to 2nd panel E1
 *    +-------------------------------------------+                  |           |
 *    |10 | DB7  | Data Bit 7                     | AVR Pin ---------+ B5     D2 +-------> to 2nd panel E2
 *    +-------------------------------------------+                  |           |
...
#define glcd_ConfigName "Bills-BB-v2Teensy-dualvk5121"
/*
...
#define glcdPinE3	PIN_D3
#define glcdPinE4	PIN_D2
